...
/**
 * AsyncTask to call REST methods/interface perform notification subscription.
 * If user is not null, then it calls Secured API otherwise publi one
 */
public class NotificationSubscriptionAsyncTask extends AsyncTask<Void, Void, Void> {
    ...
    /**
     * User can be null, then Public API endpoint is used to su
     * bscribe.
     *
